...
class DeviceAdapter(private val values: List<BluetoothDevice>,
                    private val onDeviceClickListener: OnDeviceClickListener? = null) : RecyclerView.Adapter<DeviceAdapter.ViewHolder>() {
